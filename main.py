...
def generate_section(prompt: str, additional_instructions: str):
    stream = st.session_state.groq.chat.completions.create(
        ...
        messages=[
            ...
            {
                "role": "user",
                "content": f"Generate a long, comprehensive, structured chapter. Important!!! to detect and use language of the section title,additional instructions  to generate the structure. Use the following section and important instructions:\n\n<section_title>{prompt}</section_title>\n\n<additional_instructions>{additional_instructions}</additional_instructions>",
            },
        ],
        temperature=0.3,
        max_tokens=8000,
